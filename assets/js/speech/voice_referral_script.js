...
var noteTextarea = $('#nots_description');
...
function notes_voice_ajax(noteContent){
    var nots_title = $("#nots_title").val();
    var Host = $("#base_url").val();
    $.ajax({
        type: 'POST',
        url: Host + "referral/notes_voice_ajax",
        data: "nots_title="+nots_title+"&noteContent=" + noteContent,
        success: function(data) {
            var json = $.parseJSON(data);
            $("#nots_description").val(json.note_content);
            $("#nots_title").val(json.note_title);
