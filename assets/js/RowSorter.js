!function (a, b) {
    ...
    function a(b, e) {
        if (!(this instanceof a))
            return new a(b, e);
        if ("string" == typeof b && (b = c(b)), d(b, "table") === !1)
            throw new Error("Table not found.");
        return b[r] instanceof a ? b[r] : (this._options = l(s, e), this._table = b, this._tbody = b, this._rows = [], this._lastY = !1, this._draggingRow = null, this._firstTouch = !0, this._lastSort = null, this._ended = !0, this._b_mousedown = this._mousedown.bind(this), this._b_mousemove = this._mousemove.bind(this), this._b_mouseup = this._mouseup.bind(this), this._b_touchstart = this._touchstart.bind(this), this._b_touchmove = this._touchmove.bind(this), this._b_touchend = this._touchend.bind(this), this._touchId = null, this._table[r] = this, void this.init())
    }

    function b(b) {
        return b instanceof a ? b : ("string" == typeof b && (b = c(b)), d(b, "table") && r in b && b[r] instanceof a ? b[r] : null)
    }

    function c(a) {
        var b = m(document, a);
        return b.length > 0 && d(b[0], "table") ? b[0] : null
    }
    ...
    function j(a, b) {
        if (b = b.trim(), "" !== b)
            if (-1 === b.indexOf(" "))
                i(a, b) === !1 && (a.classList ? a.classList.add(b) : a.className += " " + b);
            else
                for (var c = b.replace(/\s+/g, " ").split(" "), d = 0, e = c.length; e > d; d++)
                    j(a, c[d])
    }
    ...
    function k(a, b) {
        if (b = b.trim(), "" !== b)
            if (-1 === b.indexOf(" "))
                i(a, b) && (a.classList ? a.classList.remove(b) : a.className = a.className.replace(new RegExp("(\\s|^)" + b + "(\\s|$)"), " "));
            else
                for (var c = b.replace(/\s+/g, " ").split(" "), d = 0, e = c.length; e > d; d++)
                    k(a, c[d])
    }
    ...
    function m(a, b) {
        return p ? p.makeArray(p(a).find(b)) : a.querySelectorAll(b)
    }
    ...
    var p = window.jQuery || !1,
            q = !!("ontouchstart" in document),
            r = "data-rowsorter",
            s = {
                handler: null,
                tbody: !0,
    ...
    return a.prototype.init = function () {
        ...
        if ("function" != typeof this._options.onDragStart && (this._options.onDragStart = null), "function" != typeof this._options.onDrop && (this._options.onDrop = null), ("number" != typeof this._options.stickTopRows || this._options.stickTopRows < 0) && (this._options.stickTopRows = 0), ("number" != typeof this._options.stickBottomRows || this._options.stickBottomRows < 0) && (this._options.stickBottomRows = 0), g(this._table, "mousedown", this._b_mousedown), g(document, "mouseup", this._b_mouseup), q && (g(this._table, "touchstart", this._b_touchstart), g(this._table, "touchend", this._b_touchend)), "onselectstart" in document) {
            var b = this;
            g(document, "selectstart", function (a) {
        ...
        if (this._draggingRow) {
            ...
            if (0 !== c) {
                var d = n(a, "tr");
                if (d && d !== this._draggingRow && -1 !== o(d, this._rows)) {
                    var g = !0;
                    if (this._options.stickTopRows > 0 || this._options.stickBottomRows > 0) {
                        var h = f(this._tbody, d);
                        (this._options.stickTopRows > 0 && h < this._options.stickTopRows || this._options.stickBottomRows > 0 && h >= this._rows.length - this._options.stickBottomRows) && (g = !1)
                    }
                    g && e(this._draggingRow, d, c), this._lastY = b
                }
            }
        }
    }, a.prototype._mouseup = function () {
        this._end()
    }, a.prototype._touchend = function (a) {
        a.changedTouches.length > 0 && this._touchId === a.changedTouches[0].identifier && this._end()
    }, a.prototype._end = function () {
        if (!this._draggingRow)
            return !0;
        this._options.tableClass && k(this._table, this._options.tableClass), this._options.dragClass && k(this._draggingRow, this._options.dragClass);
        var a = f(this._tbody, this._draggingRow);
        if (a !== this._oldIndex) {
        ...
        this._draggingRow = null, this._lastY = !1, this._touchId = null, this._ended = !0, h(this._table, "mousemove", this._b_mousemove), q && h(this._table, "touchmove", this._b_touchmove)
        ...
        this._table[r] = null, this._ended === !1 && this._end(), h(this._table, "mousedown", this._b_mousedown), h(document, "mouseup", this._b_mouseup), q && (h(this._table, "touchstart", this._b_touchstart), h(this._table, "touchend", this._b_touchend))
    }, a.revert = function (a, c) {
        var d = b(a);
        if (null === d && c === !1)
            throw new Error("Table not found.");
        d && d.revert()
