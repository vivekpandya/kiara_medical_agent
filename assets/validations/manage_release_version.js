...
var ManageReleaseVersion = function () {
    ...
    var handleDetails = function () {
        $('.manage_release_version_form').validate({
            ...
            invalidHandler: function (event, validator) { //display error alert on form submit  
                $('.alert-error1', $('.manage_release_version_form')).hide();
                $('.alert-error', $('.manage_release_version_form')).show();
            },
        ...
        $('.manage_release_version_form input').keypress(function (e) {
            if (e.which == 13) {
                if ($('.manage_release_version_form').validate().form()) {
                   setTimeout(function () {
                        form.submit();
                    }, 1000);
                }
    ...
    var handleWebinarForm = function () {
        $('.manage_seminar_form').validate({
            errorElement: 'label', //default input error message container
            errorClass: 'error', // default input error message class
            focusInvalid: true, // do not focus the last invalid input
            rules: {
                ...
                se_title: {
                    required: "Please enter webinar title",
                },
                se_seminar_date: {
                  required: "Please select webinar date",  
                },
                se_timezone: {
            ...
            invalidHandler: function (event, validator) { //display error alert on form submit  
                $('.alert-error1', $('.manage_seminar_form')).hide();
                $('.alert-error', $('.manage_seminar_form')).show();
            },
            highlight: function (element) { // hightlight error inputs
                $(element).closest('.input-append').addClass('error'); // set error class to the control group
            },
        ...
        $('.manage_seminar_form input').keypress(function (e) {
            if (e.which == 13) {
                if ($('.manage_seminar_form').validate().form()) {
                   setTimeout(function () {
                        form.submit();
                    }, 1000);
                }
    ...
    var handleSaveWebinarUserForm = function(){        
        $('.manage_webinar_user_form').validate({
            errorElement: 'label', //default input error message container
            errorClass: 'error', // default input error message class
            focusInvalid: true, // do not focus the last invalid input
            rules: {
                ...
                sr_dcc_name: {
                  required: "Day Care Center name is required",  
                },
                sr_email: {
            ...
            invalidHandler: function (event, validator) { //display error alert on form submit  
                $('.alert-error1', $('.manage_webinar_user_form')).hide();
                $('.alert-error', $('.manage_webinar_user_form')).show();
            },
            highlight: function (element) { // hightlight error inputs
                $(element).closest('.input-append').addClass('error'); // set error class to the control group
            },
        ...
        $('.manage_webinar_user_form input').keypress(function (e) {
            if (e.which == 13) {
                if ($('.manage_webinar_user_form').validate().form()) {
                   setTimeout(function () {
                        form.submit();
                    }, 1000);
                }
