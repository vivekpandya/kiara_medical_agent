...
function loadDataByPage(page) {
    setTimeout(function () {
        ...
        $.ajax({
            type: 'POST',
            url: Host + "reports/claim_not_generated_dataPagi",
            //data: "page=" + page + "&status=" + status + "&schedule_date=" + schedule_date + "&sort=" + sort + "&colname=" + colname + "&shift_timings=" + shiftTiming + "&client_dob=" + $('#client_dob').val() + "&client_schedule=" + $('#client_schedule').val() + "&client_name=" + $('#client_name').val() + "&client_id=" + $('#client_id').val(),
            data: "startdate=" + startdate + "&enddate=" + enddate+ "&sts=" + sts + "&page=" + page + "&sort=" + sort + "&colname=" + colname + "&ptype=" + ptype,
...
function shiftPrint() {
    ...
    $.ajax({
        type: 'POST',
        url: Host + "Schedule/dashboard_shift_print",
...
function shiftExport() {
    ...
    $.ajax({
        type: 'POST',
        url: Host + "Schedule/dashboard_shift_export",
        data: "page=" + page + "&status=" + status + "&schedule_date=" + schedule_date + "&sort=" + sort + "&colname=" + colname + "&shift_timings=" + shiftTiming + "&cli_dob=" + $('#client_dob').val() + "&client_schedule=" + $('#client_schedule').val() + "&client_name=" + $('#client_name').val() + "&client_id=" + $('#client_id').val(),
        success: function (data) {
            hideloader();
            if (data != "No_Data")
